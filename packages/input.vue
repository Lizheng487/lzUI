<template>
  <div class="lz-input "  :class="{'lz-input__suffix':showIcon}" :style="{width}">
    <input
      class="lz-input__inner"
      ...
      @input="handleInput"
    />
    <span class="lz-input__suffix" v-if="showIcon">
      <i
        class="lz-icon-guanbi"
        v-if="clearable && value && type !== 'password'"
        @click="clearInput"
      ></i>
      <i
        class="lz-icon-yanjing"
